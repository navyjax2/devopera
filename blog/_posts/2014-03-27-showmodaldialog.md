...
Note:  The dialog-polyfill example on noted on GitHub is NOT compatible with IE, as it relies on the 2015 ECMAScript standard construct "Promise", which is not yet supported by IE 11:  https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise
